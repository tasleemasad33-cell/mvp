...
const ParcelDetails = () => {
    ...
    if (!parcel) {
        return <div className="p-8">Parcel not found. Redirecting...</div>;
    }
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-gray-500">
                            <div className="flex items-center gap-1.5">
                                ...
                                <span>{parcel.location || 'Location not set'}</span>
                            </div>
                            <div className="flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-gray-500 font-medium">Crop Details</h3>
                    </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-gray-500 font-medium">Area Size</h3>
                    </div>
                    <p className="text-2xl font-bold text-gray-900">{parcel.area} Ha</p>
                    <p className="text-gray-500">Registered Land</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 transition-colors">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h3 className="text-gray-500 font-medium">Timeline</h3>
                    </div>
                    <div className="space-y-1">
                        <p className="font-semibold text-gray-900">Planted: {parcel.plantingDate}</p>
                        <p className="text-gray-500">Harvest: {parcel.harvestDate || 'Not set'}</p>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 lg:col-span-3 hover:border-emerald-200 transition-colors mt-2">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-gray-500 font-medium text-lg">Soil Analytics</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div className="border-r border-gray-100 last:border-0 pr-4">
                            <p className="text-sm text-gray-500 mb-1">Soil Texture</p>
                            <p className="text-xl font-bold text-gray-900">{parcel.soilTexture || 'Not Sampled'}</p>
                        </div>
                        <div className="border-r border-gray-100 last:border-0 pr-4">
                            <p className="text-sm text-gray-500 mb-1">Soil pH</p>
                            <p className="text-xl font-bold text-gray-900">{parcel.soilPh || '—'}</p>
                            <p className="text-xs text-gray-400 font-medium">
                                {Number(parcel.soilPh) < 6.5 ? 'Acidic' : Number(parcel.soilPh) > 7.5 ? 'Alkaline' : 'Neutral'}
                            </p>
                        </div>
                        <div>
                            <p className="text-sm text-gray-500 mb-1">Organic Matter</p>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-lg font-bold text-emerald-800 flex items-center gap-2">
                            <Calendar className="w-5 h-5 text-emerald-500" /> Planned Activities & Advisory
                        </h2>
                        <button
